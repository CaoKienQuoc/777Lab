...
const LANG_KEYS = {
  vi: {
    ...
    blogAndPosts: 'Blog & Bài viết', newPost: '+ Đăng bài mới', emptyBlog: 'Chưa có bài viết nào.', emptyBlogHint: 'Nhấn “Đăng bài mới” để tạo bài viết đầu tiên.', editPost: 'Sửa bài viết', newPostTitle: 'Đăng bài mới', postDetail: 'Bài viết', cancel: 'Huỷ', save: 'Lưu thay đổi', post: 'Đăng bài', deletePost: 'Xoá bài viết', deletePostConfirm: 'Bạn có chắc chắn muốn xoá bài viết này? Hành động không thể hoàn tác.', deletePostDone: 'Đã xoá bài viết.', postSaved: 'Đã cập nhật bài viết.', postCreated: 'Đã đăng bài viết.', close: 'Đóng', title: 'Tiêu đề', content: 'Nội dung', image: 'Hình ảnh (tuỳ chọn)', selectImage: '📷 Bấm để chọn ảnh (JPG, PNG, GIF, WEBP — tối đa 5MB)', removeImage: 'Xoá ảnh hiện tại', pleaseEnterTitleAndContent: 'Vui lòng nhập tiêu đề và nội dung.', saving: 'Đang lưu...', wantToDelete: 'Bạn có chắc muốn xoá?', by: 'bởi', schedulePost: 'Thời Gian', scheduledToday: 'Hôm nay có {n} bài viết theo lịch', newBlogToast: 'Có {n} bài viết mới', notifTitle: 'Thông báo', notifEmpty: 'Chưa có thông báo nào.', notifMarkAll: 'Đánh dấu đã đọc', notifBlogNew: 'Bài viết mới', notifMeetingReminder: 'Nhắc lịch họp', notifPrev: '‹ Trước', notifNext: 'Sau ›', rteBold: 'In đậm', rteItalic: 'In nghiêng', rteUnderline: 'Gạch chân', rteFont: 'Font chữ', rteSize: 'Cỡ chữ', rteSizeS: 'Nhỏ', rteSizeM: 'Vừa', rteSizeL: 'Lớn', rteSizeXL: 'Rất lớn', rteColor: 'Màu chữ',
